...
!function (t, e) {
  ...
  define.amd ? define(e) : (t = 'undefined' != typeof globalThis ? globalThis : t || self).Chart = e()
}(
  this,
  (
    function () {
      ...
      const h = (t, e) => 'string' == typeof t &&
      t.endsWith('%') ? parseFloat(t) / 100 : + t / e,
      c = (t, e) => 'string' == typeof t &&
      t.endsWith('%') ? parseFloat(t) / 100 * e : + t;
      function d(t, e, i) {
      ...
      function _(t, e, i) {
        ...
        n = i[t];
        o(s) &&
        o(n) ? x(s, n) : Object.prototype.hasOwnProperty.call(e, t) ||
        (e[t] = g(n))
      }
      const y = {
        '': t => t,
      ...
      function j(t, e, i) {
        ...
        n,
        o;
        for (s = 0, n = t.length; s < n; s++) o = t[s][i],
        isNaN(o) ||
      ...
      function tt(t, e, i, s = 0.000001) {
        return t >= Math.min(e, i) - s &&
        t <= Math.max(e, i) + s
      }
      function et(t, e, i) {
        i = i ||
      ...
      function at(t, e) {
        t._chartjs ? t._chartjs.listeners.push(e) : (
      ...
      function mt(t) {
        ...
        if (!s) return t._scaleRanges = n,
        !0;
        const o = s.xmin !== e.min ||
        s.xmax !== e.max ||
        s.ymin !== i.min ||
        s.ymax !== i.max;
          ...
          this._charts.forEach(
            (
              (i, s) => {
                ...
                r &&
                (s.draw(), this._notify(s, i, t, 'progress')),
                n.length ||
 ...
 */
        ...
        (
          Ht = function () {
            ...
            for (s = 0; s < e.length; s++) {
              for (a = r = e[s], n = 0; n < i.length; n++) o = i[n],
              r = r.replace(o, Wt[o]);
              o = parseInt(Nt[a], 16),
              t[r] = [
                o >> 16 & 255,
      ...
      function ne(t, e, i) {
        return function (t, e) {
          ...
          let s = se.get(i);
          return s ||
          (s = new Intl.NumberFormat(t, e), se.set(i, s)),
          s
        }(e, i).format(t)
      }
      const oe = {
        ...
        logarithmic(t, e, i) {
          if (0 === t) return '0';
          const s = i[e].significand ||
          t / Math.pow(10, Math.floor(z(t)));
          return [1,
          2,
          3,
          5,
          10,
          15].includes(s) ||
          e > 0.8 * i.length ? oe.numeric.call(this, t, e, i) : ''
        }
      };
      var ae = {
        formatters: oe
      ...
      var ue = new de({
        ...
        function (t) {
          ...
          t.describe(
            'scale.ticks',
            {
              _scriptable: t => 'backdropPadding' !== t &&
              'callback' !== t,
      ...
      function ve(t, e) {
        ...
        = e;
        return o &&
        (f -= a.width + r.width, g -= a.height + r.height),
        {
      ...
      function we(t, e, i, s) {
        const n = me(t),
        o = _e(n, 'margin'),
        a = pe(n.maxWidth, t, 'clientWidth') ||
        T,
        r = pe(n.maxHeight, t, 'clientHeight') ||
        T,
        l = function (t, e, i) {
          let s,
          n;
      ...
      function De(t) {
        return !t ||
        s(t.size) ||
        s(t.family) ? null : (t.style ? t.style + ' ' : '') + (t.weight ? t.weight + ' ' : '') + t.size + 'px ' + t.family
      }
      function Ce(t, e, i, s, n) {
        let o = e[n];
        return o ||
        (o = e[n] = t.measureText(n).width, i.push(n)),
        o > s &&
        (s = o),
        s
      }
      function Oe(t, e, i, s) {
        ...
        for (h = 0; h < l; h++) if (u = i[h], null == u || n(u)) {
          if (n(u)) for (c = 0, d = u.length; c < d; c++) f = u[c],
          null == f ||
          n(f) ||
          (r = Ce(t, o, a, r, f))
        } else r = Ce(t, o, a, r, u);
      ...
      function ri(t, e = 'x') {
        ...
        !function (t, e, i) {
          ...
          l,
          h = ni(t, 0);
          for (let c = 0; c < s - 1; ++c) l = h,
          h = ni(t, c + 1),
          l &&
          h &&
          (
            V(e[c], 0, si) ? i[c] = i[c + 1] = 0 : (
              n = i[c] / e[c],
              o = i[c + 1] / e[c],
      ...
      function Yi(t, e, i, s, n, o) {
        return o ||
        t.isPointInArea(e) ? 'r' !== i ||
        s ? $i(t, e, i, s, n, o) : function (t, e, i, s) {
          let n = [];
          return Hi(
            t,
            i,
      ...
      function ys(t, e, i) {
        ...
        function (t, e) {
          bs.size ||
          window.addEventListener('resize', _s),
          bs.set(t, e)
        }(t, o),
        a
      }
      function vs(t, e, i) {
        ...
        function (t) {
          bs.delete(t),
          bs.size ||
          window.removeEventListener('resize', _s)
        }(t)
      }
      function Ms(t, e, i) {
        const s = t.canvas,
      ...
      function ks(t) {
        ...
        t instanceof OffscreenCanvas ? ls : ws
      }
      ...
      class Os {
        ...
        _createAnimations(t, e) {
          ...
          for (r = o.length - 1; r >= 0; --r) {
            ...
            d &&
            d.duration ? (n[l] = c = new Cs(d, t, l, h), s.push(c)) : t[l] = h
          }
          return s
        }
        update(t, e) {
      ...
      class Ns {
        ...
        _dataCheck() {
          ...
          if (o(e)) this._data = function (t) {
            ...
            n,
            o;
            for (s = 0, n = e.length; s < n; ++s) o = e[s],
            i[s] = {
              x: o,
              y: t[o]
            };
        ...
        parse(t, e) {
          ...
          f = t > 0 &&
          i._parsed[t - 1];
          if (!1 === this._parsing) i._parsed = s,
          i._sorted = !0,
          d = s;
           else {
            ...
            f &&
            c[l] < f[l];
            for (h = 0; h < e; ++h) i._parsed[h + t] = c = d[h],
            u &&
            (a() && (u = !1), f = c);
            i._sorted = u
          }
        ...
        getAllParsedValues(t) {
          ...
          n,
          o;
          for (s = 0, n = e.length; s < n; ++s) o = e[s][t.axis],
          a(o) &&
          i.push(o);
          return i
        }
        ...
        draw() {
          ...
          for (i.dataset && i.dataset.draw(t, n, a, r), h = a; h < a + r; ++h) {
            const e = s[h];
            e.hidden ||
            (e.active && l ? o.push(e) : e.draw(t, n))
          }
        ...
        getStyle(t, e) {
          ...
          return void 0 === t &&
          this._cachedMeta.dataset ? this.resolveDatasetElementOptions(i) : this.resolveDataElementOptions(t || 0, i)
        }
        getContext(t, e, i) {
        ...
        getSharedOptions(t) {
          if (t.$shared) return this._sharedOptions ||
          (this._sharedOptions = Object.assign({
          }, t))
        }
        includeOptions(t, e) {
          return !e ||
        ...
        _removeDatasetHoverStyle() {
          ...
          t &&
          this._setStyle(t, void 0, 'active', !1)
        }
        _setDatasetHoverStyle() {
          const t = this._cachedMeta.dataset;
          t &&
          this._setStyle(t, void 0, 'active', !0)
        }
        _resyncElements(t) {
          const e = this._data,
          ...
          for (const [t,
          e,
          i]of this._syncList) this[t](e, i);
          this._syncList = [];
          const s = i.length,
          n = e.length,
          o = Math.min(n, s);
          o &&
          this.parse(0, o),
          n > s ? this._insertElements(s, n - s, t) : n < s &&
        ...
        _onDataPush() {
          ...
          this._sync(['_insertElements',
          this.getDataset().data.length - t,
          t])
        }
        _onDataPop() {
          this._sync(['_removeElements',
      ...
      function js(t, e) {
        ...
        a = i.major.enabled ? function (t) {
          ...
          let i,
          s;
          for (i = 0, s = t.length; i < s; i++) t[i].major &&
          e.push(i);
          return e
        }(e) : [],
        r = a.length,
        ...
        if (r > o) return function (t, e, i, s) {
          ...
          o = 0,
          a = i[0];
          for (s = Math.ceil(s), n = 0; n < t.length; n++) n === a &&
          (e.push(t[n]), o++, a = i[o * s])
        }(e, c, a, r / o),
        c;
      ...
      function $s(t, e, i, s, n) {
        ...
        c = Math.round(o + d * i);
        for (h = Math.max(o, 0); h < a; h++) h === c &&
        (e.push(t[h]), d++, c = Math.round(o + d * i))
      }
      const Ys = (t, e, i) => 'top' === e ||
      'left' === e ? t[e] + i : t[e] - i,
      ...
      class Js extends Hs {
        ...
        _calculatePadding(t, e, i, s) {
          ...
          if (this.isHorizontal()) {
            ...
            let c = 0,
            d = 0;
            r ? l ? (c = s * t.width, d = i * e.height) : (c = i * t.height, d = s * e.width) : 'start' === n ? d = e.width : 'end' === n ? c = t.width : 'inner' !== n &&
        ...
        _computeLabelSizes(t, e, i) {
          ...
          for (c = 0; c < e; c += h) {
            if (
              ...
              if (n(g)) for (d = 0, f = g.length; d < f; ++d) v = g[d],
              s(v) ||
              n(v) ||
              (_ = Ce(o, b.data, b.gc, _, v), y += x)
            } else _ = Ce(o, b.data, b.gc, _, g),
            y = x;
            r.push(_),
            l.push(y),
            M = Math.max(_, M),
        ...
        getPixelForTick(t) {
          const e = this.ticks;
          return t < 0 ||
          t > e.length - 1 ? null : this.getPixelForValue(e[t].value)
        }
        ...
        _computeGridLineItems(t) {
          ...
          C,
          O;
          if ('top' === a) x = b(this.bottom),
          w = this.bottom - u,
          S = x - m,
          D = b(t.top) + m,
          O = t.bottom;
           else if ('bottom' === a) x = b(this.top),
          D = t.top,
          O = b(t.bottom) - m,
          w = x + m,
          S = this.top + u;
           else if ('left' === a) x = b(this.right),
          M = this.right - u,
          k = x - m,
          P = b(t.left) + m,
          C = t.right;
           else if ('right' === a) x = b(this.left),
          P = t.left,
          C = b(t.right) - m,
          M = x + m,
          k = this.left + u;
        ...
        _computeLabelItems(t) {
          ...
          O,
          A = 'middle';
          if ('top' === s) w = this.bottom - p,
          k = this._getXAxisLabelAlignment();
           else if ('bottom' === s) w = this.top + p,
          k = this._getXAxisLabelAlignment();
           else if ('left' === s) {
          ...
          for (x = 0, _ = l.length; x < _; ++x) {
            ...
            if (
              r ? (
                ...
                O = 'top' === s ? 'near' === c ||
                0 !== m ? - C * D + D / 2 : 'center' === c ? - T.highest.height / 2 - e * D + D : - T.highest.height + D / 2 : 'near' === c ||
                0 !== m ? D / 2 : 'center' === c ? T.highest.height / 2 - e * D : T.highest.height - C * D,
                u &&
                (O *= - 1),
                0 === m ||
                t.showLabelBackdrop ||
        ...
        _getXAxisLabelAlignment() {
          ...
          let i = 'center';
          return 'start' === e.align ? i = 'left' : 'end' === e.align ? i = 'right' : 'inner' === e.align &&
          (i = 'inner'),
          i
        }
        ...
        drawTitle() {
          ...
          'bottom' === e ||
          'center' === e ||
          o(e) ? (h += r.bottom, n(i.text) && (h += a.lineHeight * (i.text.length - 1))) : h += r.top;
          const {
            titleX: c,
            titleY: d,
            maxWidth: u,
        ...
        register(t) {
          ...
          (
            ...
            function (t, e, i) {
              ...
              t.descriptors &&
              ue.describe(e, t.descriptors)
            }(t, o, i),
            this.override &&
            ue.override(t.id, t.overrides)
          ),
          o
        }
        get(t) {
        ...
        _each(t, e, i) {
          [
            ...
            (
              e => {
                const s = i ||
                this._getRegistryForType(e);
                i ||
                s.isForType(e) ||
                s === this.plugins &&
                e.id ? this._exec(t, s, e) : u(
                  e,
                  (e => {
                    const s = i ||
                    this._getRegistryForType(e);
                ...
                (
                  t => {
                    const e = function (t, e) {
                      let i = t;
                      return '_index_' === t ? i = e : '_value_' === t &&
                      (i = 'x' === e ? 'y' : 'x'),
                      i
                    }(t, o),
                    n = i[e + 'AxisID'] ||
        ...
        getOptionScopes(t, e, i) {
          ...
          e.forEach(
            (
              e => {
                t &&
                (r.add(t), e.forEach((e => mn(r, t, e)))),
                e.forEach((t => mn(r, s, t))),
                e.forEach((t => mn(r, re[n] || {
                }, t))),
      ...
      const _n = t => o(t) &&
      Object.getOwnPropertyNames(t).some((e => S(t[e])));
      const yn = [
        'top',
        'bottom',
        'left',
      ...
      class An {
        ...
        update(t) {
          ...
          = this;
          r ? this._eventHandler(r, !0) : a.length &&
          this._updateHoverStyles(a, a, !0),
          this.render()
        }
        _updateScales() {
          u(this.scales, (t => {
        ...
        _updateDatasets(t) {
          if (
            !1 !== this.notifyPlugins('beforeDatasetsUpdate', {
              mode: t,
              cancelable: !0
            })
          ) {
        ...
        render() {
          ...
          (
            xt.has(this) ? this.attached &&
            !xt.running(this) &&
            xt.start(this) : (this.draw(), wn({
              chart: this
            }))
          )
        }
        ...
        _drawDatasets() {
          if (
            !1 === this.notifyPlugins('beforeDatasetsDraw', {
              cancelable: !0
            })
          ) return;
        ...
        updateHoverStyle(t, e, i) {
          ...
          for (
            ...
            o = t[a];
            const e = o &&
            this.getDatasetMeta(o.datasetIndex).controller;
            e &&
        ...
        _updateHoverStyles(t, e, i) {
          ...
          a = i ? t : n(t, e);
          o.length &&
          this.updateHoverStyle(o, s.mode, !1),
          a.length &&
          s.mode &&
      ...
      function In(t) {
        ...
        for (s = 0, n = i.length; s < n; ++s) o = e.getPixelForValue(i[s]),
        l();
      ...
      class jn extends Ns {
        ...
        _getRotationExtents() {
          let t = O,
          e = - O;
          for (let i = 0; i < this.chart.data.datasets.length; ++i) if (
        ...
        _circumference(t, e) {
          ...
          return e &&
          i.animation.animateRotate ||
          !this.chart.getDataVisibility(t) ||
          null === s._parsed[t] ||
          s.data[t].hidden ? 0 : this.calculateCircumference(s._parsed[t] * n / O)
        }
        updateElements(t, e, i, s) {
          const n = 'reset' === s,
          o = this.chart,
        ...
        getMaxBorderWidth(t) {
          ...
          if (!t) return 0;
          for (s = 0, n = t.length; s < n; ++s) r = a.resolveDataElementOptions(s),
          'inner' !== r.borderAlign &&
        ...
        _getRingWeightOffset(t) {
          let e = 0;
          for (let i = 0; i < t; ++i) this.chart.isDatasetVisible(i) &&
      ...
      var Yn = Object.freeze({
        ...
        BarController: class extends Ns {
          ...
          _calculateBarIndexPixels(t, e) {
            ...
            } else r = i.getPixelForValue(this.getParsed(t) [i.axis], t),
          ...
          draw() {
            ...
            s = i.length;
            let n = 0;
            for (; n < s; ++n) null !== this.getParsed(n) [e.axis] &&
            i[n].draw(this._ctx)
          }
        },
        ...
        LineController: class extends Ns {
          ...
          updateElements(t, e, i, n) {
            ...
            b = this.chart._animationsDisabled ||
            o ||
            'none' === n,
            x = e + i,
            _ = t.length;
            ...
            for (let i = 0; i < _; ++i) {
              ...
              k = _[f] = o ||
              M ? r.getBasePixel() : r.getPixelForValue(l ? this.applyStack(r, v, l) : v[f], i);
              _.skip = isNaN(w) ||
              isNaN(k) ||
              M,
              _.stop = i > 0 &&
        ...
        ScatterController: class extends Ns {
          ...
          updateElements(t, e, i, n) {
            ...
            for (let c = e; c < e + i; ++c) {
              ...
              M = p[g] = o ||
              y ? r.getBasePixel() : r.getPixelForValue(l ? this.applyStack(r, i, l) : i[g], c);
              p.skip = isNaN(v) ||
              isNaN(M) ||
              y,
              p.stop = c > 0 &&
      ...
      function Qn(t, e, i, s) {
        ...
        = Jn(n, i, s),
        c = function (t) {
          return t.stepped ? Fe : t.tension ||
          'monotone' === t.cubicInterpolationMode ? Ve : Zn
        }(o);
        let d,
        u,
        f,
        ...
        for (d = 0; d <= h; ++d) u = n[(r + (p ? h - d : d)) % a],
        u.skip ||
        (g ? (t.moveTo(u.x, u.y), g = !1) : c(t, f, u, p, o.stepped), f = u);
        return l &&
        (u = n[(r + (p ? h : 0)) % a], c(t, f, u, p, o.stepped)),
        !!l
      }
      function to(t, e, i, s) {
        const n = e.points,
      ...
      function so(t, e, i, s) {
        io &&
        !e.options.segment ? function (t, e, i, s) {
          let n = e._path;
          n ||
          ...
          = e,
          a = eo(e);
          for (const r of n) Gn(t, o, r.style),
          t.beginPath(),
          a(t, e, r, {
            start: i,
            end: i + s - 1
      ...
      class no extends Hs {
        ...
        interpolate(t, e) {
          ...
          const a = [],
          r = function (t) {
            return t.stepped ? pi : t.tension ||
            'monotone' === t.cubicInterpolationMode ? mi : gi
          }(i);
          let l,
          h;
      ...
      function go(t, e, i, s) {
        ...
        if ( - 1 === n) return (
          (t, e, i, s) => (
            'string' == typeof e ? (i = t.push(e) - 1, s.unshift({
              index: i,
              label: e
            })) : isNaN(e) &&
            (i = null),
      ...
      class bo extends Js {
        ...
        buildTicks() {
          ...
          const n = function (t, e) {
            ...
            (S = B(k * S / g / f) * f),
            s(l) ||
            (v = Math.pow(10, l), S = Math.ceil(S * v) / v),
            'ticks' === n ? (M = Math.floor(p / S) * S, w = Math.ceil(m / S) * S) : (M = p, w = m),
            b &&
            x &&
            o &&
            H((r - a) / o, S / 1000) ? (k = Math.round(Math.min((r - a) / S, c)), S = (r - a) / k, M = a, w = r) : _ ? (M = b ? a : M, w = x ? r : w, k = h - 1, S = (w - M) / k) : (
              k = (w - M) / S,
              k = V(k, Math.round(k), S / 1000) ? Math.round(k) : Math.ceil(k)
            );
            ...
            u &&
            w !== r ? i.length &&
            V(i[i.length - 1].value, r, mo(r, y, t)) ? i[i.length - 1].value = r : i.push({
              value: r
            }) : x &&
            w !== r ||
            i.push({
            ...
            minRotation: e.minRotation ||
            0,
            includeBounds: !1 !== e.includeBounds
          }, this._range || this);
          return 'ticks' === t.bounds &&
          j(n, this, 'value'),
      ...
      class ko extends Js {
        ...
        getPixelForValue(t) {
          ...
          (t = this.min),
          null === t ||
          isNaN(t) ? NaN : this.getPixelForDecimal(t === this.min ? 0 : (z(t) - this._startValue) / this._valueRange)
        }
        getValueForPixel(t) {
      ...
      function Co(t, e, i, s, n) {
        ...
        n.start < e.t ? (l = (e.t - n.start) / a, t.t = Math.min(t.t, e.t - l)) : n.end > e.b &&
      ...
      function Lo(t, e, i, s) {
        ...
        if (i) n.arc(t.xCenter, t.yCenter, e, 0, O);
          ...
          n.moveTo(i.x, i.y);
          for (let o = 1; o < s; o++) i = t.getPointPosition(o, e),
          n.lineTo(i.x, i.y)
        }
      }
      class Eo extends bo {
        ...
        fit() {
          const t = this.options;
          t.display &&
          t.pointLabels.display ? Do(this) : this.setCenterPoint(0, 0, 0, 0)
        }
      ...
      function Fo(t, e) {
        ...
        (l = n(l)),
        a(l) ||
        (l = 'string' == typeof n ? i.parse(l, n) : i.parse(l)),
        null === l ? null : (
          o &&
          (
            l = 'week' !== o ||
            !N(r) &&
            !0 !== r ? i.startOf(l, o) : i.startOf(l, 'isoWeek', r)
          ),
          + l
        )
      }
      ...
      function Wo(t, e, i) {
        ...
        i ? function (t, e, i, s) {
          ...
          let r,
          l;
          for (r = o; r <= a; r = + n.add(r, 1, s)) l = i[r],
          l >= 0 &&
          (e[l].major = !0);
          return e
        }(t, s, n, i) : s
      ...
      class No extends Js {
        ...
        determineDataLimits() {
          ...
          s = a(s) &&
          !isNaN(s) ? s : + e.startOf(Date.now(), i),
          n = a(n) &&
          !isNaN(n) ? n : + e.endOf(Date.now(), i) + 1,
        ...
        buildTicks() {
          ...
          s.length &&
          (
            this.min = this._userMin ||
            s[0],
            this.max = this._userMax ||
            s[s.length - 1]
          );
          const n = this.min,
          o = nt(s, n, this.max);
          ...
          (
            i.autoSkip ? Vo(e.minUnit, this.min, this.max, this._getLabelCapacity(n)) : function (t, e, i, s, n) {
          ...
          this._majorUnit = i.major.enabled &&
          'year' !== this._unit ? function (t) {
        ...
        _generate() {
          ...
          n = s.time,
          o = n.unit ||
          Vo(n.minUnit, e, i, this._getLabelCapacity(e)),
        ...
        _getLabelCapacity(t) {
          ...
          s = i[e.unit] ||
          i.millisecond,
          n = this._tickFormatFunction(t, 0, Wo(this, [
            t
          ], this._majorUnit), s),
      ...
      var jo = Object.freeze({
        ...
        CategoryScale: class extends Js {
          ...
          parse(t, e) {
            ...
            return ((t, e) => null === t ? null : J(Math.round(t), 0, e)) (
              e = isFinite(e) &&
              i[e] === t ? e : go(i, t, l(e, t), this._addedLabels),
              i.length - 1
            )
          }
          determineDataLimits() {
        ...
        TimeSeriesScale: class extends No {
          ...
          buildLookupTable(t) {
            ...
            l,
            h;
            for (o = 0, a = t.length; o < a; ++o) l = t[o],
            l >= e &&
            l <= i &&
            s.push(l);
            ...
            for (o = 0, a = s.length; o < a; ++o) h = s[o + 1],
            r = s[o - 1],
            l = s[o],
            Math.round((h + r) / 2) !== l &&
            n.push({
          ...
          _getTimestampsForTable() {
            ...
            return t = e.length &&
            i.length ? this.normalize(e.concat(i)) : e.length ? e : i,
            t = this._cache.all = t,
            t
          }
          getDecimalForValue(t) {
                  ...
                  case 'lttb':
                    f = function (t, e, i, s, n) {
                      ...
                      for (a[l++] = t[p], c = 0; c < o - 2; c++) {
                        ...
                        = t[p];
                        for (u = f = - 1, s = x; s < _; s++) f = 0.5 * Math.abs((y - n) * (t[s].y - v) - (y - t[s].x) * (o - v)),
                        f > u &&
                        (u = f, d = t[s], g = s);
                        a[l++] = d,
                        p = g
      ...
      function aa(t, e, i) {
        ...
        if (o(s)) return !isNaN(s.value) &&
        s;
        let n = parseFloat(s);
        return a(n) &&
        Math.floor(n) === n ? function (t, e, i, s) {
          '-' !== t &&
          '+' !== t ||
          (i = e + i);
      ...
      function ca(t) {
        ...
        const n = function (t) {
          ...
          return function (t) {
            ...
            s = function (t, e) {
              let i = null;
              return 'start' === t ? i = e.bottom : 'end' === t ? i = e.top : o(t) ? i = e.getPixelForValue(t.value) : e.getBasePixel &&
              (i = e.getBasePixel()),
              i
            }(i, e);
            if (a(s)) {
      ...
      var ma = {
        ...
        afterDatasetsUpdate(t, e, i) {
          ...
          r,
          l;
          for (a = 0; a < s; ++a) o = t.getDatasetMeta(a),
          r = o.dataset,
          l = null,
          r &&
          r.options &&
      ...
      class xa extends Hs {
        ...
        drawTitle() {
          ...
          c = this.left,
          d = this.width;
          if (this.isHorizontal()) d = Math.max(...this.lineWidths),
          h = this.top + l,
        ...
        _getLegendItemAt(t, e) {
          ...
          s,
          n;
          if (tt(t, this.left, this.right) && tt(e, this.top, this.bottom)) for (n = this.legendHitBoxes, i = 0; i < n.length; ++i) if (
            s = n[i],
      ...
      class va extends Hs {
        ...
        _drawArgs(t) {
          ...
          h,
          c = 0;
          return this.isHorizontal() ? (l = ft(a, i, n), h = e + t, r = n - i) : (
      ...
      function Pa(t, e) {
        return e &&
        (n(e) ? Array.prototype.push.apply(t, e) : t.push(e)),
        t
      }
      function Da(t) {
      ...
      function Aa(t, e, i, s) {
        ...
        = t;
        let h = 'center';
        return 'center' === s ? h = n <= (r + l) / 2 ? 'left' : 'right' : n <= o / 2 ? h = 'left' : n >= a - o / 2 &&
        (h = 'right'),
        function (t, e, i, s) {
          const {
            x: n,
      ...
      function La(t, e, i, s) {
        ...
        return 'center' === l ? 'left' === r ? g += h : 'right' === r &&
        (g -= h) : 'left' === r ? g -= Math.max(c, u) + n : 'right' === r &&
        (g += Math.max(d, f) + n),
        {
      ...
      const za = {
        ...
        beforeLabel: e,
        label(t) {
          if (this && this.options && 'dataset' === this.options.mode) return t.label + ': ' + t.formattedValue ||
          t.formattedValue;
      ...
      class Va extends Hs {
        ...
        _drawColorBox(t, e, i, s, n) {
          ...
          if (n.usePointStyle) {
            ...
            t.lineWidth = o(a.borderWidth) ? Math.max(...Object.values(a.borderWidth)) : a.borderWidth ||
            1,
            t.strokeStyle = a.borderColor,
        ...
        drawBody(t, e, i) {
          ...
          for (
            ...
            u(this.beforeBody, p),
            f = a &&
            'right' !== m ? 'center' === o ? l / 2 + h : l + 2 + h : 0,
            y = 0,
            M = s.length;
            y < M;
            ++y
      ...
      var Ba = {
        ...
        afterDraw(t) {
          ...
          if (e && e._willRender()) {
            ...
            if (
              !1 === t.notifyPlugins('beforeTooltipDraw', {
                ...i,
                cancelable: !0
              })
            ) return;
