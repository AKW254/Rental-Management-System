!function (a, b, c, d) {
  ...
  e.Workers = [
    ...
    },
    {
      ...
      run: function () {
        ...
        g = d.loop &&
        c.length ? d.rewind ? e : Math.max(e, f) : 0,
        h = '',
        i = '';
    ...
    },
    {
      ...
      run: function () {
        ...
        h = g + this.width() * e,
        i = [];
        for (c = 0, d = this._coordinates.length; d > c; c++) a = this._coordinates[c - 1] ||
        0,
  ...
  e.prototype.closest = function (b, c) {
    ...
    this.settings.loop ||
    (
      this.op(b, '>', g[this.minimum()]) ? d = b = this.minimum() : this.op(b, '<', g[this.maximum()]) &&
      (d = b = this.maximum())
    ),
    d
  },
  e.prototype.animate = function (b) {
    ...
    a.support.transform3d &&
    a.support.transition ? this.$stage.css({
    ...
    if (b.type === e.Type.Event) {
      if (
        ...
        a.event.special[b.name]._default = function (a) {
          ...
          !c.apply ||
          a.namespace &&
          - 1 !== a.namespace.indexOf('owl') ? a.namespace &&
          a.namespace.indexOf('owl') > - 1 : c.apply(this, arguments)
        },
        a.event.special[b.name].owl = !0
      }
    } else b.type === e.Type.State &&
    (
...
function (a, b, c, d) {
  ...
  e.prototype.thumbnail = function (b, c) {
    ...
    f,
    g = c.width &&
    c.height ? 'style="width:' + c.width + 'px;height:' + c.height + 'px;"' : '',
    h = b.find('img'),
    i = 'src',
    j = '',
    ...
    h.length ? (l(h.attr(i)), h.remove(), !1) : void (
      'youtube' === c.type ? (f = 'http://img.youtube.com/vi/' + c.id + '/hqdefault.jpg', l(f)) : 'vimeo' === c.type &&
      a.ajax({
        type: 'GET',
  ...
  e.prototype.play = function (b) {
    ...
    (
      ...
      'youtube' === f.type ? c = '<iframe width="' + g + '" height="' + h + '" src="http://www.youtube.com/embed/' + f.id + '?autoplay=1&v=' + f.id + '" frameborder="0" allowfullscreen></iframe>' : 'vimeo' === f.type &&
      (
  ...
  e.prototype.isInFullScreen = function () {
    ...
    return b &&
    a(b).parent().hasClass('owl-video-frame')
  },
  e.prototype.destroy = function () {
    var a,
    b;
...
function (a, b, c, d) {
      ...
      'prepared.owl.carousel': a.proxy(
        function (b) {
          ...
          this._templates.push(
            '<div class="' + this._core.settings.dotClass + '">' + a(b.content).find('[data-dot]').andSelf('[data-dot]').attr('data-dot') + '</div>'
          )
        },
        this
      ),
  ...
  e.prototype.draw = function () {
    ...
    (
      ...
      c.dotsData &&
      0 !== b ? this._controls.$absolute.html(this._templates.join('')) : b > 0 ? this._controls.$absolute.append(new Array(b + 1).join(this._templates[0])) : 0 > b &&
  ...
  e.prototype.to = function (b, c, d) {
    var e;
    d ? a.proxy(this._overrides.to, this._core) (b, c) : (
