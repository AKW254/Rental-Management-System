...
$sql = "SELECT 
            rs.room_title,
            t.user_name AS requested_by,
            l.user_name AS requested_to,
        ...
        INNER JOIN users AS l ON mr.assigned_to = l.user_id
                ...
                <div class="modal-body">
                    <form id="editrequestForm-<?php echo $row['maintenance_request_id'] ?>">
                        <div class="row">
                            ...
                            <?php } else { ?>
                                <input type="hidden" name="maintenance_request_status" value="<?php echo $row['maintenance_request_status'] ?>">
                            <?php } ?>
