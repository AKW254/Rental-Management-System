<?php
$res = $mysqli->query("SELECT inv.invoice_id,inv.agreement_id AS agreement_id,inv.invoice_date ,inv.invoice_due_date,inv.invoice_amount,inv.invoice_status FROM invoices AS inv
