...
while ($mailer = $res->fetch_object()) {
    ...
    $mail->Subject = 'Rental Agreement Activated';
  ...
  <head>
    ...
    <title>Rental Agreement Activated</title>
    <style>
    body {
      margin: 0;
      padding: 0;
  ...
  <body>
    <div class="container">
    <div class="header">
      <h1>Rental Agreement Activated</h1>
    </div>
    <div class="content">
      <h2>Hello ' . $tenant_name . ',</h2>
      <p>Your rental agreement for ' . $room_title . ' at ' . $property_name . ', located at ' . $property_location . ', has been activated. It start from  ' . $agreement_start_date . '. Your rent is Ksh.' . $room_rent . ' for this month.</p>
