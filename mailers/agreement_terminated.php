...
while ($mailer = $res->fetch_object()) {
    ...
    $mail->Subject = 'Rental Agreement Termination';
  ...
  <head>
    ...
    <title>Rental Agreement Termination</title>
    <style>
    body {
      margin: 0;
      padding: 0;
  ...
  <body>
    <div class="container">
    <div class="header">
      <h1>Rental Agreement Termination</h1>
    </div>
    <div class="content">
      <h2>Hello ' . $tenant_name . ',</h2>
      <p>Your rental agreement for ' . $room_title . ' at ' . $property_name . ', located at ' . $property_location . ', has been terminated starting from  ' . $agreement_end_date . '. </p>
