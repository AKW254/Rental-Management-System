...
while ($mailer = $res->fetch_object()) {
    ...
    $mail->Subject = 'New Rental Agreement Created';
  ...
  <head>
    ...
    <title>New Rental Agreement Created</title>
    <style>
    body {
      margin: 0;
      padding: 0;
  ...
  <body>
    ...
    <div class="content">
      ...
      <p>You have a new rental agreement created for ' . $room_title . ' for ' . $property_name . ' the property located at ' . $property_location . ' by ' . $tenant_name . '.It was created on '. $agreement_created_at.'</p>
