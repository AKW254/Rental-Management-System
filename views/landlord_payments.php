    ...
    <div class="container-scroller">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="table-responsive">
                                        <table id="landlord_paymentTable" class="table">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                            ...
                                            <tbody id="landlordPaymentTableBody">
                ...
                <script src="../public/assets/vendors/datatables.net-bs4/landlord-payment-table.js"></script>
