            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="page-header">
                        <h3 class="page-title">Landlord Invoices </h3>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="landlord_dashboard">Landlord Dashboard</a></li>
                            ...
                            <div class="row">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12 col-md-6 col-xl-6">
                                                                    ...
                                                                    <select name="property_id" id="property_id" class="form-control p_input">
                                                                        <?php
                                                                        $sql = "SELECT property_id, property_name FROM properties WHERE property_manager_id = " . $_SESSION['user_id'] . " ORDER BY property_name ASC";
                                ...
                                <div class="col-12">
                                    <div class="table-responsive">
                                        <table id="landlord_invoiceTable" class="table">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>Invoice No</th>
                                        ...
                                        <?php include '../helpers/modals/landlord_invoices.php'; ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                $rooms_by_property = [];
                $sql = "SELECT rm.room_id, rm.room_title, ra.agreement_id, rm.property_id FROM rental_agreements AS ra 
                INNER JOIN rooms AS rm ON ra.room_id = rm.room_id 
                INNER JOIN properties AS pm ON rm.property_id = pm.property_id
                WHERE ra.agreement_status = 'Active' AND pm.property_manager_id = " . $_SESSION['user_id'] . " ORDER BY rm.room_title ASC";
                ...
                <script src="../public/assets/vendors/datatables.net-bs4/landlord_invoice-table.js"></script>
