    ...
    <div class="container-scroller">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
                <a class="sidebar-brand brand-logo" href="index.html"><img src="https://demo.bootstrapdash.com/corona-new/themes/assets/images/logo.svg" alt="logo" /></a>
                <a class="sidebar-brand brand-logo-mini" href="/"><img src="https://demo.bootstrapdash.com/corona-new/themes/assets/images/logo-mini.svg" alt="logo" /></a>
            </div>
            <ul class="nav">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="navbar p-0 fixed-top d-flex flex-row">
                <div class="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
                    <a class="navbar-brand brand-logo-mini" href="index.html"><img src="https://demo.bootstrapdash.com/corona-new/themes/assets/images/logo-mini.svg" alt="logo" /></a>
                </div>
...
<!-- Mirrored from demo.bootstrapdash.com/corona-new/themes/modern-vertical/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Mar 2025 12:26:14 GMT -->
