            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="page-header">
                        <h3 class="page-title"> My Properties </h3>
                                                        ...
                                                        <form id="createPropertyForm" method="POST">
                                                            <div class="row">
                                                                <div class="col-sm-12 col-md-6 col-xl-6">
                                                                    ...
                                                                    <input type="hidden" name="property_manager_id" id="property_manager_id" value="<?php echo $_SESSION['user_id']; ?>" class="form-control p_input">
                                                                </div>
                                                                <div class="col-sm-12 col-md-6 col-xl-6">
                                ...
                                <div class="col-12">
                                    <div class="table-responsive">
                                        <table id="propertyTable" class="table">
                                            ...
                                            <tbody id="mypropertyTableBody">
                                                <!-- DataTables will populate via Datatable initilazation -->
                                            </tbody>

                                        </table>
                                        <?php include '../helpers/modals/myproperty_modal.php'; ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        document
                            ...
                            .forEach(form => {
                                form.addEventListener('submit', async function(e) {
                                    ...
                                    try {
                                        const res = await fetch('../functions/edit_my_property.php', {
                                            method: 'POST',
                                            body: formData
                                        });
                                        const result = await res.json();
                ...
                <script src="../public/assets/vendors/datatables.net-bs4/myproperty-table.js"></script>
