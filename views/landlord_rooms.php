...
<body class="sidebar-icon-only sidebar-fixed">
    <div class="container-scroller">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="page-header">
                        <h3 class="page-title"> My Rooms </h3>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="dashboard">Landlord Dashboard</a></li>
                                <li class="breadcrumb-item active" aria-current="page">My Rooms</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="card">
                            ...
                            <div class="row">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-12 col-md-6 col-xl-6">
                                                                    ...
                                                                    <select name="property_id" id="property_id" class="form-control p_input">
                                                                        ...
                                                                        <?php
                                                                        $sql = "SELECT property_name,property_id FROM properties WHERE property_manager_id = {$_SESSION['user_id']}";
                                ...
                                <div class="col-12">
                                    <div class="table-responsive">
                                        <table id="myroomTable" class="table">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>Room No</th>
                                        ...
                                        <?php include '../helpers/modals/myroom_modal.php'; ?>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <script src="../public/assets/vendors/datatables.net-bs4/myroom-table.js"></script>
